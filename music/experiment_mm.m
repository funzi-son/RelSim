function experiment_mm(exp_setting)
...
log_file = strcat(exp_dir,'MM_SMARGIN',lm,'exp_',str_date,'.mat');
num_case = size(trn_inx,1); 
for hidN = [30 50 100 150]
for lr  = [0.01 0.03 0.05 0.07 0.1] % Best [0.05 0.1 0.2]
for ls  = [0]% 0.01 0.02 0.03]
for ps  = [0]%[0.0001 0.001 0.01 0.1]    
...
logging(log_file,[hidN lr ls ps cxx cr_ cr]);
toc;
end
end
clc;
