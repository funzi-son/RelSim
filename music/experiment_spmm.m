function experiment_spmm(exp_setting)
...
log_file = strcat(exp_dir,'SP_SMARGIN',lm,'exp_',str_date,'.mat');
num_case = size(trn_inx,1); 
for hidN = [50 100]
for lr  = [0.05 0.07 0.1] % Best [0.05 0.1 0.2]
...
logging(log_file,[hidN lr ls ps rel cxx cr_ cr]);
toc;
end
end
clc;
